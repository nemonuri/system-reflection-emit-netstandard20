...
namespace System.Reflection.Emit.NetStandard20
{
    ...
    internal sealed partial class SymbolType : TypeInfo
    {
        ...
        internal static Type? FormCompoundType(string? format, Type baseType, int curIndex)
        {
            ...
            if (format[curIndex] == '[')
            {
                ...
                while (format[curIndex] != ']')
                {
                    ...
                    if (Net70.System.Char.IsAsciiDigit(format[curIndex]) || format[curIndex] == '-')
                    {
                        ...
                        while (Net70.System.Char.IsAsciiDigit(format[curIndex]))
                        {
                            iLowerBound *= 10;
        ...
        public bool IsSZArray => _rank <= 1 && _isSzArray;
